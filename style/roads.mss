...
@motorroad-casing: #4266f5;
@toll-casing: #5c2387;
@motorroad-toll-casing: #821779;

@tertiary-shield: #4a483b;
  ...
  ::casing {
    ...
    [feature = 'highway_trunk'] {
      [zoom >= 12] {
        ...
        [zoom >= 13] {
          ...
          [toll = 'yes'] {
            [motorroad = 'yes'] {
              line-color: @motorroad-toll-casing;
            }
            [motorroad != 'yes'] {
              line-color: @toll-casing;
            }
    ...
    [feature = 'highway_primary'] {
      [zoom >= 12] {
        ...
        [toll = 'yes'] [motorroad = 'yes'] [zoom >= 13] {
          line-color: @motorroad-toll-casing;
        }
        [toll = 'yes'] [motorroad != 'yes'] [zoom >= 13] {
          line-color: @toll-casing;
...
#turning-circle-fill {
  ...
  [int_tc_type = 'trunk'][zoom >= 15][int_surface = 'unpaved'] {
    line-pattern-type: repeat;
    line-pattern-alignment: global;
    line-pattern-width: @trunk-width-z15 * 1.6;
    line-pattern-file: url("symbols/unpaved/unpaved_trunk-fill.svg");
    [zoom >= 17] {
      line-pattern-width: @trunk-width-z17 * 1.6;
    }
    [zoom >= 18] {
      line-pattern-width: @trunk-width-z18 * 1.6;
    }
    [zoom >= 19] {
      line-pattern-width: @trunk-width-z19 * 1.6;
    }
    line-pattern-cap: round;
    line-pattern-join: round;
  }
  ...
  [int_tc_type = 'busway'][zoom >= 16][int_surface != 'unpaved'],
  [int_tc_type = 'bus_guideway'][zoom >= 16][int_surface != 'unpaved'] {
  ...
  [int_tc_type = 'bus_guideway'][zoom >= 16][int_surface = 'unpaved'] {
    line-pattern-type: repeat;
    line-pattern-alignment: global;
    line-pattern-width: @busway-width-z16 * 1.6;
    line-pattern-file: url("symbols/unpaved/unpaved_busway-fill.svg");
    [zoom >= 17] {
      line-pattern-width: @busway-width-z17 * 1.6;
    }
    [zoom >= 18] {
      line-pattern-width: @busway-width-z18 * 1.6;
    }
    [zoom >= 19] {
      line-pattern-width: @busway-width-z19 * 1.6;
    }
    [zoom >= 20] {
      line-pattern-width: @busway-width-z20 * 1.6;
    }
    line-pattern-cap: round;
    line-pattern-join: round;
  }
